...
<head>
    ...
    <title>SJC Ents - My Events</title>
...
$sql_p = "SELECT * FROM hlb_events WHERE NOW() > event_end_datetime AND crsid_booked LIKE '".$user."' ORDER BY event_start_datetime DESC"; 
    ...
    <main>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            foreach($future as $val){  
                                ...
                                echo '<tr>';
                                    echo '<td><a href="event?id='.$val['event_id'].'">'.$val['event_name'].'</a></td>';
        ...
        <div class="container">
            <div class="text-center"><a class="btn btn-primary btn-lg border-light" data-toggle="collapse" aria-expanded="false" aria-controls="collapse-1" href="#collapse-1" role="button" style="background: rgba(167,167,167,0.15);color: rgb(108,117,125);font-family: Montserrat, sans-serif;">Past Events</a>
                ...
                echo '<p style="font-family: Montserrat, sans-serif;">No past events found.</p>';
            }
            ?>
            </div>
        </div>
