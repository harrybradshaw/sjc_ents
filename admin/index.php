...
if(in_array($_SERVER['REMOTE_USER'],['hlb54','sp770','dw545','hm404','cmfg2','mms72','ms2340','ojrb2','djr76','lcm67'])){
    ...
    if($view == 'event'){
        ...
        foreach($res as $val){
            ...
            echo '<br><a href="event?id='.$val['event_id'].'"> Edit Event Details</a>';
            echo '<br><a href="../event?id='.$val['event_id'].'"> View Event</a>';
